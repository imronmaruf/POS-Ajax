...
<body>
    ...
    <!-- particles js -->
    <script src="{{ asset('be/assets/libs/particles.js/particles.js') }}"></script>
    <!-- particles app js -->
    <script src="{{ asset('be/assets/js/pages/particles.app.js') }}"></script>
    <!-- password-addon init -->
    {{-- <script src="{{ asset('be/assets/js/pages/password-addon.init.js') }}"></script> --}}
    {{-- 
